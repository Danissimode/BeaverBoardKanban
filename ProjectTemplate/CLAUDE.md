...
This workspace is orchestrated by the **Beaver Board Kanban** app (a kanban that dispatches agents against tickets).
...
The Beaver Board background engine reads `automations.json` and launches `claude` CLI subprocesses in this working directory. Agents interact with the board via the Beaver Board API above.
