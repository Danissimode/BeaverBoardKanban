...
public sealed class EndpointsRefactorTests : IClassFixture<EndpointsRefactorTests.ApiFactory>, IDisposable
{
    ...
    private static readonly HashSet<string> ExpectedRoutes = new(StringComparer.Ordinal)
    {
        ...
        // Command Hub
        "POST /api/command-hub/projects/{slug}/command",
        "GET /api/command-hub/projects/{slug}/conversations/{conversationId}/messages",
        "GET /api/command-hub/projects/{slug}/plans/pending",
        "POST /api/command-hub/projects/{slug}/plans/{planId}/approve",
        "POST /api/command-hub/projects/{slug}/plans/{planId}/reject",
        // Health Center
        "GET /api/health-center/events/{slug}",
        "GET /api/health-center/events/{slug}/open",
        "GET /api/health-center/events/{slug}/by-category/{category}",
        "GET /api/health-center/events/{slug}/ticket/{ticketId}",
        "GET /api/health-center/events/{slug}/agent/{agentId}",
        "GET /api/health-center/overview/{slug}",
        "GET /api/health-center/watchdogs/{slug}",
        "GET /api/health-center/failures/{slug}",
        "GET /api/health-center/system/{slug}",
        "POST /api/health-center/events/{slug}/{eventId}/acknowledge",
        "POST /api/health-center/events/{slug}/{eventId}/dismiss",
        "POST /api/health-center/events/{slug}/{eventId}/resolve",
        // Tree
        "GET /api/tree/projects/{slug}/tickets/{parentId}/children",
        "GET /api/tree/projects/{slug}/tickets/{rootId}/subtree",
        "GET /api/tree/projects/{slug}/tickets/{parentId}/progress",
        "POST /api/tree/projects/{slug}/tickets/{ticketId}/reparent",
        "POST /api/tree/projects/{slug}/tickets/{rootId}/move-subtree",
        "GET /api/tree/projects/{slug}/tickets/{ticketId}/would-cycle/{newParentId}",
        "GET /api/tree/projects/{slug}/tickets/{ticketId}/dependencies",
        "GET /api/tree/projects/{slug}/tickets/{ticketId}/blocking",
        "POST /api/tree/projects/{slug}/dependencies",
        "GET /api/tree/projects/{slug}/tickets/{parentId}/parallel-groups",
        "POST /api/tree/projects/{slug}/parallel-groups",
        "GET /api/tree/projects/{slug}/tickets/{ticketId}/can-decompose",
        "POST /api/tree/projects/{slug}/tickets/{ticketId}/decompose/preview",
        "POST /api/tree/projects/{slug}/tickets/{ticketId}/decompose/apply",
        "GET /api/tree/projects/{slug}/tickets/{ticketId}/leaves",
        "GET /api/tree/projects/{slug}/tickets/{ticketId}/leaf-progress",
        // Team Roles
        "GET /api/team/projects/{slug}/roles",
        "GET /api/team/projects/{slug}/roles/{roleId}",
        "PUT /api/team/projects/{slug}/roles/{roleId}",
        "GET /api/team/projects/{slug}/agents",
        "GET /api/team/projects/{slug}/agents/role/{roleId}",
        "PUT /api/team/projects/{slug}/agents/{agentId}",
        "GET /api/team/projects/{slug}/execution-profiles",
        "GET /api/team/projects/{slug}/execution-profiles/{profileId}",
        "PUT /api/team/projects/{slug}/execution-profiles/{profileId}",
        "GET /api/team/projects/{slug}/tickets/{ticketId}/role",
        "PUT /api/team/projects/{slug}/tickets/{ticketId}/role",
        "GET /api/team/projects/{slug}/roles/{roleId}/policies",
        "PUT /api/team/projects/{slug}/roles/{roleId}/policies/{policyId}",
        "GET /api/team/projects/{slug}/inboxes",
        "GET /api/team/projects/{slug}/inboxes/{inboxId}/pending",
        "POST /api/team/projects/{slug}/inboxes/{inboxId}/post",
        "POST /api/team/projects/{slug}/inboxes/messages/{messageId}/claim",
        "GET /api/team/projects/{slug}/sessions/active",
        "GET /api/team/projects/{slug}/tickets/{ticketId}/sessions",
        "POST /api/team/projects/{slug}/sessions",
        "PUT /api/team/projects/{slug}/sessions/{sessionId}/state",
        "GET /api/team/projects/{slug}/conversation-policy",
        "PUT /api/team/projects/{slug}/conversation-policy",
        "POST /api/team/projects/{slug}/messages/route",
        "GET /api/team/projects/{slug}/activity",
        "GET /api/team/projects/{slug}/sessions/{sessionId}/messages",
        "POST /api/team/projects/{slug}/tickets/{ticketId}/dispatch",
        "GET /api/team/projects/{slug}/orchestrator/plans",
        "POST /api/team/projects/{slug}/orchestrator/plan",
        "POST /api/team/projects/{slug}/orchestrator/plans/{planId}/approve",
        "POST /api/team/projects/{slug}/orchestrator/plans/{planId}/cancel",
        // Roster
        "GET /api/roster/slots",
        "GET /api/roster/slots/{id}",
        "PUT /api/roster/slots/{id}",
        "DELETE /api/roster/slots/{id}",
        "GET /api/roster/presets",
        "GET /api/roster/presets/active",
        "GET /api/roster/presets/{id}",
        "PUT /api/roster/presets/{id}",
        "POST /api/roster/presets/{id}/activate",
        "GET /api/roster/fallbacks",
        "GET /api/roster/fallbacks/{id}",
        "PUT /api/roster/fallbacks/{id}",
        "GET /api/roster/opencode-config",
        "POST /api/roster/opencode-config/write",
        "POST /api/roster/resolve/{ticketId}",
        "POST /api/roster/tickets/{ticketId}/assign",
        "GET /api/roster/tickets/{ticketId}/assignment",
        "DELETE /api/roster/tickets/{ticketId}/assignment",
    };
