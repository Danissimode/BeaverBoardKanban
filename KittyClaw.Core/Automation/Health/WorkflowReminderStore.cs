...
public sealed class WorkflowReminderStore
{
    ...
    private static WorkflowReminder ReadReminder(SqliteDataReader r) => new()
    {
        ...
        DueAt = r.IsDBNull(r.GetOrdinal("DueAt")) ? null : DateTimeOffset.Parse(r.GetString(r.GetOrdinal("DueAt"))).DateTime,
        Interval = r.IsDBNull(r.GetOrdinal("IntervalTicks")) ? null : TimeSpan.FromTicks(r.GetInt64(r.GetOrdinal("IntervalTicks"))),
